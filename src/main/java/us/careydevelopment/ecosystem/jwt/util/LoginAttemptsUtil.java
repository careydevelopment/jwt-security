 ...
 * Doesn't return anything, just throws an exception if the user failed login
...
public class LoginAttemptsUtil {
    ...
    /**
     * Check to make sure this user hasn't failed authentication too many times from
     * the same IP address.
     */
